...
void System::TrackStereoWithMask(const cv::Mat &imLeft, const cv::Mat &imRight, 
                                ...
                                const double &timestamp)
{
    ...
    cv::Mat Tcw = mpTracker->GrabImageStereoWithMask(imLeft, imRight, imMaskLeft, imMaskRight, timestamp);
